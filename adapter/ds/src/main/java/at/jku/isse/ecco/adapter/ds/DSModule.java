...
public class DSModule extends AbstractModule {
	...
	protected void configure() {
		...
		readerMultibinder.addBinding().to(DSReader.class);
		...
		exporterMultibinder.addBinding().to(DSExporter.class);
		 */
	}
