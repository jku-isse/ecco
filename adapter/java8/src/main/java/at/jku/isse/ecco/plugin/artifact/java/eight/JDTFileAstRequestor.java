...
import at.jku.isse.ecco.plugin.artifact.java.eight.jdtast.Jdt2JavaAstVisitor;
import at.jku.isse.ecco.plugin.artifact.java.eight.jdtast.ReferencedAstVisitor;
import at.jku.isse.ecco.plugin.artifact.java.eight.jdtast.ReferencingAstVisitor;
...
public class JDTFileAstRequestor extends FileASTRequestor {
    ...
    public void acceptAST(String sourceFileName, CompilationUnit cu) {
        ...
        Artifact.Op<PluginArtifactData> pluginArtifactData = entityFactory.createArtifact(
                new PluginArtifactData(Java8Plugin.getPluginIdStatic(),
