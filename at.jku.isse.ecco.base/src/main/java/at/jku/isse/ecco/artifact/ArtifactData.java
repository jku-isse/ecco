...
public interface ArtifactData extends Serializable {
	...
	/**
	 * Artifact data types must provide a hash code implementation..
	 *
	...
	/**
	 * Artifact data types must provide an equals implementation.
	 *
	...
	/**
	 * Artifact data types must provide a toString implementation.
	 *
