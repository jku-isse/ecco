...
public class FeatureRevisionLocationTest {
    ...
    public final String resultsCSVs_path = "C:\\Gabriela\\CaseStudies\\FeaturesCurl";
    //directory with the folder "variant_results" inside the folder with the artifacts of the target systyem
    public final String resultMetrics_path = "C:\\Gabriela\\CaseStudies\\FeaturesCurl\\variant_results";
    //directory with the file "configurations.csv" inside the folder with the artifacts of the target systyem
    public final String configuration_path = "C:\\Gabriela\\CaseStudies\\FeaturesCurl\\configurations.csv";
