 ...
 */
public class SerArtifact<DataType extends ArtifactData> implements Artifact<DataType>, Artifact.Op<DataType> {
	...
	public SerArtifact(DataType data) {
		this(data, false);
	}

	public SerArtifact(DataType data, boolean ordered) {
		checkNotNull(data);
		this.data = data;
	...
	public boolean equals(Object o) {
		...
		SerArtifact<?> that = (SerArtifact<?>) o;
	...
	public void addUses(Artifact.Op target, String type) {
		...
		ArtifactReference.Op artifactReference = new SerArtifactReference(type);
