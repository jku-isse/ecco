...
public class EccoService implements ProgressInputStream.ProgressListener, ProgressOutputStream.ProgressListener, ReadListener, WriteListener, Closeable {
    ...
    public static final String REPOSITORY_DIR_NAME = ".ecco";
    public static final String DEFAULT_BASE_DIR = "";
    public static final String DEFAULT_REPOSITORY_DIR = DEFAULT_BASE_DIR + '/' + REPOSITORY_DIR_NAME;
    public static final String CONFIG_FILE_NAME = ".config";
    public static final String WARNINGS_FILE_NAME = ".warnings";
    public static final String HASHES_FILE_NAME = ".hashes";
    public static final String IGNORES_FILE_NAME = ".ignores";
     ...
     */
    public EccoService() {
        this(Paths.get(DEFAULT_BASE_DIR), Paths.get(DEFAULT_REPOSITORY_DIR));
...
//		this.ignoredFiles.add(CONFIG_FILE_NAME);
        ...
        this.defaultIgnorePatterns.add("glob:" + REPOSITORY_DIR_NAME);
        this.defaultIgnorePatterns.add("glob:" + CONFIG_FILE_NAME);
        this.defaultIgnorePatterns.add("glob:" + WARNINGS_FILE_NAME);
        this.defaultIgnorePatterns.add("glob:" + HASHES_FILE_NAME);
...
//		}
     ...
     *
     * @param paths The collection of paths (files or directories) to map.
     * @return
     */
