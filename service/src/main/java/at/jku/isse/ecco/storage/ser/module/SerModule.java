 ...
 */
public class SerModule implements Module {
	...
	private Feature[] neg;
	private int count;
	private Collection<SerModuleRevision> revisions;


	public SerModule(Feature[] pos, Feature[] neg) {
		checkNotNull(pos);
		checkNotNull(neg);
	...
	@Override
	public Collection<SerModuleRevision> getRevisions() {
	...
	public ModuleRevision getOrphanedRevision(FeatureRevision[] pos, Feature[] neg) {
		SerModuleRevision moduleRevision = this.getRevision(pos, neg);
		if (moduleRevision == null) {
			moduleRevision = new SerModuleRevision(this, pos, neg);
		}
		return moduleRevision;
	}

	@Override
	public SerModuleRevision addRevision(FeatureRevision[] pos, Feature[] neg) {
		if (!this.matchesRevision(pos, neg))
			return null;
		SerModuleRevision moduleRevision = new SerModuleRevision(this, pos, neg);
	...
	@Override
	public SerModuleRevision getRevision(FeatureRevision[] pos, Feature[] neg) {
		SerModuleRevision queryModuleRevision = new SerModuleRevision(this, pos, neg);
		for (SerModuleRevision moduleRevision : this.revisions)
	...
	public boolean equals(Object o) {
		...
		SerModule memModule = (SerModule) o;
