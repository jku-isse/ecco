...
public class XmlNode implements Node.Op, Serializable {
    ...
    public XmlNode(Artifact.Op<?> artifact) {
    ...
    public static class XmlRootNode extends XmlNode implements RootNode.Op {
