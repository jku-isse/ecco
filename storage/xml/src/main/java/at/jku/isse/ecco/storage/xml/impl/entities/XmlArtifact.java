...
public class XmlArtifact<DataType extends ArtifactData> implements Artifact<DataType>, Artifact.Op<DataType> {
    ...
    public XmlArtifact(DataType data) {
        this(data, false);
    }

    public XmlArtifact(DataType data, boolean ordered) {
        this.data = data;
    ...
    public boolean equals(Object o) {
        ...
        XmlArtifact<?> that = (XmlArtifact<?>) o;
    ...
    public void addUses(Op target, String type) {
        ...
        ArtifactReference.Op artifactReference = new XmlArtifactReference();
