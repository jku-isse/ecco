...
public class NeoCommitDao implements CommitDao {

    private final NeoTransactionStrategy transactionStrategy;

    @Inject
    public NeoCommitDao(NeoTransactionStrategy transactionStrategy, final MemEntityFactory entityFactory) {
    ...
    public Commit save(Commit entity) throws EccoException {
        final NeoRepository root = transactionStrategy.load();
