...
import static at.jku.isse.ecco.storage.json.impl.JsonPluginTransactionStrategy.RENAMED_JSON_DB_NAME;
...
public class JsonPluginRepositoryDao implements RepositoryDao {
    ...
    private void storeToFile(JsonRepository repo) throws IOException {
