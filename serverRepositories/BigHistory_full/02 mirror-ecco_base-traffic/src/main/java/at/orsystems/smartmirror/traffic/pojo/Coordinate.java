...
public class Coordinate {
    ...
    @JsonCreator
    public Coordinate(@JsonProperty(value = "Longitude", required = true) double longitude,
    ...
    public String toString() {
        return new ToStringBuilder(this).append("longitude", longitude).append("latitude", latitude)
