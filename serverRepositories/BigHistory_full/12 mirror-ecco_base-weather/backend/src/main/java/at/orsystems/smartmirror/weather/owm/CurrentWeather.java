...
@JsonPropertyOrder({"coord", "weather", "main", "visibility", "wind", "clouds", "dt", "sys", "timezone", "id", "name"})
public class CurrentWeather {
    ...
    /**
     * Contains some interal parameters from the weather station as well as the country code and the sunrise/sunset
     * information.
     */
    ...
    public CurrentWeather(@JsonProperty(value = "coordinates") @JsonAlias("coord") CoordinateDTO coordinates,
