...
public class ForecastList {
    ...
    @JsonCreator
    public ForecastList(@JsonProperty(value = "forecastDate", required = true) @JsonAlias("dt") long forecastDate,
                        ...
                        @JsonProperty(value = "speed", required = true) @JsonAlias("speed") double windSpeed,
                        @JsonProperty(value = "deg", required = true) @JsonAlias("deg") long degrees,
                        @JsonProperty(value = "clouds", required = true) @JsonAlias("clouds") double cloudiness,
                        @JsonProperty(value = "pop") Double pop,
                        @JsonProperty(value = "rain") @JsonAlias("rain") Double rainAmount,
                        @JsonProperty(value = "snow") @JsonAlias("snow") Double snowAmount) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ForecastList rhs)) {
            return false;
        }
