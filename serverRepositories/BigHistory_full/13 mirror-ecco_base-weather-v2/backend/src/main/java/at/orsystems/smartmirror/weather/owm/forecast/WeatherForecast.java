...
public class WeatherForecast {
     ...
     */
    public final List<ForecastList> forecastWeatherDays;
    @JsonIgnore
    ...
    public WeatherForecast(@JsonProperty(value = "city", required = true) City city,
                           ...
                           @JsonProperty(value = "forecastWeatherDays", required = true) @JsonAlias("list") List<ForecastList> forecastWeatherDays) {
        this.city = city;
        this.cod = cod;
