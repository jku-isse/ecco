...
public class TrafficItem {
    ...
    @JsonCreator
    public TrafficItem(@JsonProperty(value = "text", required = true) @JsonAlias("Text") @NonNull String text,
                       ...
                       @JsonProperty(value = "coordinates", required = true) @JsonAlias("Coordinates") @NonNull List<Coordinate> coordinates) {
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(eventCode, rhs.eventCode)
                                  .append(eventImage, rhs.eventImage)
