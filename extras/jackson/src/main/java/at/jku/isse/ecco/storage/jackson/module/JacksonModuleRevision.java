...
public class JacksonModuleRevision implements ModuleRevision {
	...
	public JacksonModuleRevision(JacksonModule module, FeatureRevision[] pos, Feature[] neg) {
		checkNotNull(module);
		checkNotNull(pos);
		checkNotNull(neg);
	...
	public boolean equals(Object o) {
		...
		JacksonModuleRevision memModuleRevision = (JacksonModuleRevision) o;
